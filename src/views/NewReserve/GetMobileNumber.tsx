...
export const GetMobileNumber = () => {
    ...
    const [{ Resource ,ReserveModel}, Dispatch] = useStateValue();
    ...
    const onSubmit = (e: GetMobileForm) => {
       

        if (!formik.isValid) return;
        ReserveModel.MobileNumber= e.mobile;
        const setMobileNumber: IAction<Actions, ReservePayload> = {
    ...
    const formik = useFormik<GetMobileForm>({
        initialValues: {
            mobile: "",
        ...
        validationSchema: Yup.object({
            mobile: Yup.string()
                ...
                mobileNumber("شماره همراه معتبر وارد کنید.")
            ...
            {(formik.isSubmitting && <AppLoader />) ||
                ...
                <GridContainer justify='center'>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <GridItem xs={12}>
                            <InputRenderer autoComplete="off" autoFocus tab="0" value={formik.values.mobile} error={formik.errors.mobile && true} Type={PropType.Text} Name="mobile"
                                DisplayName={getResource(Resource).MobileNumber} onChange={handleChange} placeholder={"َشماره همراه معتبر لطفاَ"}
                                Hint={formik.errors["mobile"] as string} />
